...
/*fonction qui renvoie un booleen en fonction de si oui ou non o est le symbole lambda*/
int islambda(object o) {

    if(o->type == SFS_SYMBOL && strcmp(o->this.symbol,"lambda") == 0)
        return TRUE;
    else
        return FALSE;
